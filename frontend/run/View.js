    ...
    static renderPageFromOldData(pageList, controllerRef){
        ...
        pageList.forEach(function(pageInfo){
            ...
            pageInfo.components.forEach(function(symbol){
                ...
                if (symbolType === 'line') {
                    let symbolRender = wb.line(0, 0, 1, 1).draggable(symbol.dragRun);
                ...
                if (symbolType === 'polyline'){
                    let symbolRender = wb.polyline(symbol.points).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'ellipse'){
                    let symbolRender = wb.ellipse(0,0).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'circle'){
                    let symbolRender = wb.circle(0).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'rectangle'){
                    let symbolRender = wb.rect(0,0).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'polygon'){
                    let symbolRender = wb.polygon(symbol.points).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'textblock'){
                    let symbolRender = wb.text(symbol.textContent).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'graph-view'){
                    let symbolRender = wb.image(symbol.symbolURL).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'display-value'){
                    let symbolRender = wb.text(symbol.format).draggable(symbol.dragRun);
                    symbolRender.id(symbolId).addClass('symbol');
                ...
                if (symbolType === 'h-slider'){
                    let symbolRender = wb.foreignObject(symbol.width,symbol.height).draggable(symbol.dragRun);
                ...
                if (symbolType === 'pie-chart') {
                    ...
                    let symbolRender = wb.foreignObject(width, width).draggable(symbol.dragRun);
                ...
                if (symbolType === 'donut-chart'){
                    let symbolRender = wb.foreignObject(symbol.radius*2, symbol.radius*2).draggable(symbol.dragRun);
