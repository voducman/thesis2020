...
class PositionHandlerUtil {
    ...
    */
    drawLineShape(wb) {
        ...
        $(id).mousedown((e) => {
            ...
            line = wb.line(firstPos.x, firstPos.y, firstPos.x, firstPos.y).draggable().addClass('symbol');
    ...
    drawPolylineShap(wb) {
        ...
        $(id).click((e) => {
            ...
            if (isFirst) {
                ...
                polyline.id(polyId).draggable().addClass('symbol');
    ...
    */
    drawEllipseShape(wb) {
        ...
        $(id).mousedown((e) => {
            ...
            ellipse.id(ellipseId).draggable().addClass('symbol');
    ...
    */
    drawCircleShape(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            circle.radius(radius).id(circleId).draggable().addClass('symbol');
    ...
    */
    drawRectShape(wb) {
        ...
        this.drawRectPlaceholder(wb, function (width, height, pos) {
            ...
            rect.id(rectId).draggable().addClass('symbol');
    ...
    drawPolygonShape(wb) {
        ...
        $(id).click((e) => {
            ...
            if (isFirst) {
                ...
                polygon.id(polyId).draggable().addClass('symbol');
   ...
   */
    drawTextBlock(wb) {
        ...
        $(id).mousedown((e) => {
            ...
            textblock.id(textId).font('size', 20).draggable().addClass('symbol');
    ...
    */
    drawPencilHandler(wb) {
        ...
        $(id).mousedown((e) => {
            ...
            customLine.id(pencilId).draggable().addClass('symbol');
   ...
   */
    drawGraphView(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            image.id(imageId).draggable().addClass('symbol');
    ...
    */
    drawDisplayValue(wb) {
        ...
        $(id).click((e) => {
            ...
            displayValue.font('size', 20).id(displayId).draggable().addClass('symbol');
   ...
   */
    drawButton(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            button.id(buttonId).draggable().addClass('symbol');
   ...
   */
    drawSwitch(wb) {
        ...
        $(id).click((e) => {
            ...
            $switch.id(switchId).draggable().addClass('symbol');
   ...
   */
    drawInput(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            input.id(inputId).draggable().addClass('symbol');
   ...
   */
    drawHorizontalSlider(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            slider.add(html).id(sliderId).draggable().addClass('symbol');
   ...
   */
    ...
    * @param {object} wb - White board object generated by SVG library
   */
    drawProgressBar(wb, isVertical) {

        this.drawRectPlaceholder(wb, function(width, height, pos){

            const progressId = elementsUtil.getElementId('progress-bar');
            let progressBar = wb.foreignObject(width, height).move(pos.x, pos.y);
            progressBar.id(progressId).draggable(true).addClass('symbol');
            if (isVertical){
                elementsUtil.renderVerProgressBar(progressId, width, height);
            }else{
                elementsUtil.renderHorProgressBar(progressId, width, height);
            }
            eventUtil.assignDbclickToProgressBar(progressBar);
            let progressProperties = new ProgressBar(progressId, progressBar, isVertical);
   ...
   */
    drawCheckBox(wb) {
        ...
        $(id).click((e) => {
            ...
            checkbox.id(checkboxId).draggable().addClass('symbol');
   ...
   */
    drawSymbolSet(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            symbol.id(symbolId).draggable().addClass('symbol');
    ...
    */
    drawLineChart(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            lineChart.add(htmlLineChart).id(chartId).draggable().addClass('symbol');
    ...
    */
    drawBarChart(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            barChart.add(htmlBarChart).id(barChartId).draggable().addClass('symbol');
    ...
    */
    drawPieChart(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            let htmlPiechart = htmlSymbolUtil.generatePieChartHtml(pieChartId, radius*2, radius*2);
            pieChart.add(htmlPiechart).id(pieChartId).draggable().addClass('symbol');
    ...
    */
    drawDonutChart(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            donutChart.add(htmlDonutchart).id(donutChartId).draggable().addClass('symbol');
   ...
   */
    drawRadialGaugeChart(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            gauge.add(htmlGaugechart).id(gaugeId).draggable().addClass('symbol');
  ...
  */
    drawSpeedometer(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            ometer.add(htmlOmeterChart).id(ometerId).draggable().addClass('symbol');
   ...
   */
    drawLinearGaugeChart(wb) {
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            linearGauge.add(htmlgaugeChart).id(gaugeId).draggable().addClass('symbol');
    ...
    */
    drawRadialClock(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            radialClock.add(`<div></div>`).id(clockId).draggable().addClass('symbol');
    ...
    */
    drawDigitalClock(wb){
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            clock.add(htmlClock).draggable().id(clockId).addClass('symbol');
    ...
    */
    drawCameraPlayer(wb){
        ...
        this.drawRectPlaceholder(wb, function(width, height, pos){
            ...
            camera.add(htmlCamera).draggable().id(cameraId).addClass('symbol');
