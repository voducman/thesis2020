...
export default class LineChart extends BaseSymbol{
    ...
    updateModal(){
        this.updatePosition();
        modalUtil.updateLineChartModal(this);
    ...
    updateSymbol(){
        ...
        this.SVG.node.querySelector('div.ct-chart').style.width = parseInt(this.width)  + 'px';
        this.SVG.node.querySelector('div.ct-chart').style.height = parseInt(this.height) - 31 + 'px';
        this.SVG.node.querySelector('div.ct-chart').style.backgroundColor = this.backgroundColor;
