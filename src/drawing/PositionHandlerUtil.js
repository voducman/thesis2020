...
class PositionHandlerUtil {
    ...
    */
    drawLineShape(wb) {
        ...
        $(id).mousedown((e) => {
            let line;
            let firstPos = this.getMousePosition(id, e.pageX, e.pageY);
            let lineId = elementsUtil.getElementId('line');
            line = wb.line(firstPos.x, firstPos.y, firstPos.x, firstPos.y).draggable();
            line.id(lineId).stroke({ color: '#f06', width: 50, linecap: 'square' })
    ...
    */
    drawPolylineShap(wb) {
        ...
        this.setDrawingCursor(id);
        let polyId = elementsUtil.getElementId('polyline');
        $(id).click((e) => {
            let firstPos = this.getMousePosition(id, e.pageX, e.pageY);
            polyArray.push(firstPos.x, firstPos.y);
            if (isFirst) {
                isFirst = false;
                polyline = wb.polyline(polyArray).fill('none').stroke({ width: 5, color: '#3caea3' })
    ...
    */
    drawEllipseShape(wb) {
        ...
        $(id).mousedown((e) => {
            let ellipse;
            let firstPos = this.getMousePosition(id, e.pageX, e.pageY);
            let ellipseId = elementsUtil.getElementId('ellipse');
    ...
    */
    drawCircleShape(wb) {
        ...
        this.drawCirclePlaceholder(wb, function(radius, pos){
            ...
            let circle = wb.circle(0).move(pos.x, pos.y).fill('none').stroke({ width: 5, color: '#333' });
    ...
    */
    drawRectShape(wb) {
        ...
        this.drawRectPlaceholder(wb, function (width, height, pos) {
            ...
            let rect = wb.rect(width, height).move(pos.x, pos.y).fill("none").stroke({ width: 5, color: '#333' });
    ...
    */
    drawPolygonShape(wb) {
        ...
        this.setDrawingCursor(id);
        let polyId = elementsUtil.getElementId('polygon');
        $(id).click((e) => {
            let firstPos = this.getMousePosition(id, e.pageX, e.pageY);
            polyArray.push(firstPos.x, firstPos.y);
            if (isFirst) {
                polygon = wb.polygon(polyArray).fill('none').stroke({ width: 5, color: '#3caea3' })
   ...
   */
    drawTextBlock(wb) {
        ...
        $(id).mousedown((e) => {
            let firstPos = this.getMousePosition(id, e.pageX, e.pageY);
            let textId = elementsUtil.getElementId('textblock');
            let textblock = wb.text("Textblock").move(firstPos.x, firstPos.y)
            textblock.id(textId).draggable();
    ...
    */
    drawPencilHandler(wb) {
        ...
        $(id).mousedown((e) => {
            ...
            let pencilId = elementsUtil.getElementId('pencil');
            let customLine = wb.polyline(polyArray).fill('none').stroke({ width: 5, color: '#111' });
    ...
    */
    drawDisplayValue(wb) {
        ...
        $(id).click((e) => {
            ...
            displayValue.id(displayId).draggable();
